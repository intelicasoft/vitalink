...
@endif
    <p class="paragraph aligntext">{{ trans('installer_messages.welcome.message') }}</p>
       <form method="post" action="{{ url('installed') }}" id="env-form">
        {!! csrf_field() !!}
        <div class="form-group">
            <label class="col-sm-2 control-label">@lang('equicare.purchase_code'):</label>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">DB @lang('equicare.hostname')</label>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">DB @lang('equicare.username')</label>
            <div class="col-sm-10">
                <input type="text" name="username" class="form-control" required>
            </div>
        </div>
        <div class="form-group">
            <label  class="col-sm-2 control-label">DB @lang('equicare.password')</label>
            <div class="col-sm-10">
                <input type="password" class="form-control" name="password">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">@lang('equicare.database') Name</label>
            <div class="col-sm-10">
