    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body ">
                    @include ('errors.list')
                    {!! Form::model($preventive, [
                        'route' => ['preventive_maintenance.update', $preventive->id],
                        'method' => 'PATCH',
                    ]) !!}
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::select('hospital', array_unique($hospitals) ?? [], null, [
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::select('department', array_unique($departments) ?? [], null, [
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::select('unique_id', $unique_ids ?? [], $preventive->equip_id ?? null, [
                        ...
                        <div class="form-group col-md-4 report_no none-display">
                            ...
                            <input type="hidden" name="report_no" value="{{ $preventive->report_no }}" />
                            {!! Form::text('report_no', sprintf('%04d', $preventive->report_no), [
                                'class' => 'form-control',
                                $preventive->call_handle == 'internal' ? 'disabled' : '',
                            ]) !!}
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                {!! Form::text('next_due_date', date_change($preventive->next_due_date), [
                                    'class' => ['form-control', 'next_due_date'],
                                ]) !!}
                                <span class="input-group-addon">
                                    <i class="fa fa-clock-o"></i>
                                </span>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            @if ($preventive->sign_of_engineer != null)
                                 <div class="form-group col-md-4">
                                <a class="view_image_sign_of_engineer"
                                    href="{{asset('/uploads/sign_of_enginner/'.$preventive->sign_of_engineer) }}"
                                    target="_blank">
                                    View Sign Of Engineer
                                </a>
																 </div>
																@endif
                            @if (isset($preventive->sign_stamp_of_incharge))
                                 <div class="form-group col-md-4">

                                <a class="view_image_sign_stamp_of_incharge"
                                    href="{{ asset('uploads/sign_stamp_of_incharge/'.$preventive->sign_stamp_of_incharge) }}"
                                    target="_blank">
