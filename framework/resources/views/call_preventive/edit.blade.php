				...
				<div class="box-body ">
					...
					!!}
						...
						<div class="form-group col-md-4">
							...
							{!! Form::select('unique_id',$unique_ids??[],$preventive->equip_id??null,['class'=>'form-control unique_id_select2','placeholder'=>'Select Unique Id']) !!}
						</div>
						<div class="form-group col-md-4">
						...
						<div class="form-group col-md-4">
							...
							<input type="text" name="sr_no" class="form-control sr_no" value="{{ $preventive->equipment->sr_no?? '' }}" disabled/>
						</div>
						<div class="form-group col-md-4">
						...
						<div class="form-group col-md-4">
							...
							<input type="text" name="model" class=" company form-control" value="{{ $preventive->equipment->model?? '' }}" disabled/>
						</div>
						...
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<div class="input-group">
								{!! Form::text('next_due_date',date_change($preventive->next_due_date),['class'=>['form-control','next_due_date']]) !!}
								<span class="input-group-addon">
									<i class="fa fa-clock-o"></i>
								</span>
							</div>
