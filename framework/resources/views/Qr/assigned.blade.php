...
@endsection
@section('breadcrumb')
    <li class=" active">@lang('equicare.qr')</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h4 class="box-title">@lang('equicare.manage_qr')
                        @if(
                ...
                <div class="box-body table-responsive">
                    ...
                    <ul class="nav nav-tabs" style="margin-bottom: 10px">
                        <li><a href="{{route('qr.index')}}" >@lang('equicare.qr_not_assign')</a></li>
                        <li class="active"><a href="#tab2" class="active" data-toggle="tab">@lang('equicare.qr_assign')</a></li>
                    </ul>
                     <div>
                                    ...
                                    @if (isset($qr))
                                        ...
                                        @foreach ($qr as $q)
                                            <tr>
                                                ...
                                                @if($q->equipment != null)
                                                <td><a href="{{ route('equipments.edit',$q->assign_to) }}" class="" target="_blank">{{$q->equipment->name}}</a></td>
                                                @else
                                                <td><a href="#" class="" target="_blank">Equipment Deleted</a></td>
                                                @endif
    ...
    <div class="modal" tabindex="-1" role="dialog" id="exampleModal">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action="{{route('qr_sticker','assigned')}}" method="get">
