...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				@include('errors.list')
				{!! Form::model($calibration,['route'=>['calibration.update',$calibration->id], 'method'=>'PATCH','files'=>true]) !!}
				<div class="row">
					<div class="form-group col-md-4">
						...
						<div class="form-group col-md-4">
							...
							<input type="text" name="date_pm" class=" date_pm form-control" value="{{ $calibration->equipment->pm->call_register_date_time?? '' }}" disabled/>
						</div>
						<div class="form-group col-md-4">
							<label for="model"> @lang('equicare.due_pm') </label>
							<input type="text" name="due_pm" class=" due_pm form-control" value="{{ $calibration->equipment->pm->next_due_date?? '' }}" disabled/>
						</div>

					<div class="form-group col-md-4">
					{!! Form::label('date_of_calibration',__('equicare.date_of_calibration')) !!}
					{!! Form::text('date_of_calibration',date_change($calibration->date_of_calibration),['class' => 'date_of_calibration form-control']) !!}
					</div>
					<div class="form-group col-md-4">
						{!! Form::label('due_date',__('equicare.due_date')) !!}
						{!! Form::text('due_date',date_change($calibration->due_date),['class' => 'due_date form-control']) !!}
					</div>
					<div class="form-group col-md-4">
					...
					<div class="form-group col-md-4">
						...
						<a href="{{asset($calibration->calibration_certificate)}}" target="_blank" download style="font-size: 18px;">{{__('equicare.calibration_certificate')}}</a>
						@endif
					</div>
